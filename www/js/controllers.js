...
.controller('MyProfileController', function($scope, $stateParams, $state, $ionicModal, $ionicLoading, AuthService, $ionicPlatform, $cordovaCamera, $cordovaFileTransfer, Users, $jrCrop, $ionicSideMenuDelegate){
